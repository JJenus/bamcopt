...
<template>
	<div>
		<!--begin::Menu wrapper-->
		<div
			class="cursor-pointer symbol symbol-circle ms-2 symbol-35px symbol-lg-50px"
		...
		>
			...
			<div @click="closeDrawer()" class="menu-item px-5">
				<NuxtLink to="/admin/profile/" class="menu-link px-5">
					My Profile
				</NuxtLink>
			</div>
			<!--end::Menu item-->
			...
			<div class="menu-item px-5 my-1">
				<NuxLink to="/admin/settings" class="menu-link px-5">
					Account Settings
				</NuxLink>
			</div>
			<!--end::Menu item-->
