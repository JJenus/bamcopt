  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(showPreference)) {
        _push(`<div class="text-muted fw-bold d-noine"><span class="text-info">Email</span><span class="mx-3">|</span><span href="#">Notifications</span></div>`);
      } else {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/app/settings",
        onClick: ($event) => showPreference.value = true,
        class: [unref(showPreference) ? "active" : "", "nav-link text-active-primary me-6"],
        role: "button"
      }, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        onClick: ($event) => showPreference.value = false,
...
//# sourceMappingURL=settings-5a5b8284.mjs.map
